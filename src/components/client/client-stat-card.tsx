...
import type { ClientDashboardStat } from "@/lib/types/client-dashboard";
...
interface ClientStatCardProps {
  stat: ClientDashboardStat;
  index?: number;
}

export function ClientStatCard({ stat, index = 0 }: ClientStatCardProps) {
